  ...
  List<MaterialItem> getFallbackMaterials() {
    return [
      MaterialItem(
        ...
        description: "Post-industrial secondary aluminum profiles, clean sorted, zero heavy paint, dry indoor storage ready for induction smelter.",
      ...
      MaterialItem(
        ...
        ipfsHash: "bafybeicopper9999887766554433221100aabbccddeeffgghh",
        category: "copper",
        ...
        ownerName: "Gujarat Non-Ferrous Alloys Ltd",
        status: "listed",
        createdAt: DateTime.now().subtract(const Duration(days: 3)),
        purityPercentage: 99.4,
        contaminationType: "Trace polymer insulation stripped",
        contaminationPercentage: 0.6,
        recyclabilityGrade: "Grade A+ (Electrical Conductor)",
        moistureLevel: "Zero (<0.2%)",
        estimatedLotValueInr: 641750,
        unitPriceInrPerKg: 755.0,
      ),
      MaterialItem(
        id: "lot_pet_03",
        title: "Post-Consumer Clean Hot-Washed Clear PET Bottle Flakes",
        description: "Hot washed clear PET flakes, flake size 10-12mm, PVC contamination <50ppm, moisture <1%, ideal for rPET bottle preforms.",
      ...
      MaterialItem(
        id: "lot_hdpe_04",
        title: "Granulated Industrial HDPE Chemical Drums & Carboys",
        description: "Triple rinsed and granulated HDPE drums, natural and blue mix, melt flow index 0.05-0.12, suitable for drainage pipes & blow molding.",
      ...
      MaterialItem(
        ...
        description: "Mill size high-density bales of 100% corrugated packaging, moisture <12%, outthrows <1%, certified CPCB EPR paper credit eligible.",
      ...
      MaterialItem(
        ...
        description: "Grade B multi-layer telecom motherboard scrap, capacitors stripped, precious metal content verified by XRF optical spectrometry.",
