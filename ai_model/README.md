...
This directory contains the custom PyTorch & Ultralytics **YOLOv8** model training and inference pipeline for CircularChain Agent 1 (Optical Quality & Contamination Vision Engine).
...
2. Run YOLOv8 Training & Automated ONNX / TFLite Export:
```bash
