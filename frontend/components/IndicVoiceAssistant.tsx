...
export default function IndicVoiceAssistant({ onParsed }: IndicVoiceAssistantProps) {
  ...
  return (
    <div className="rounded-2xl glass-panel p-6 border border-zinc-200 dark:border-white/10 shadow-xl mb-8">
      {/* Header */}
      ...
      <p className="text-zinc-600 dark:text-zinc-400 text-xs mb-4 leading-relaxed">
      ...
      <div className="flex items-center gap-2 mb-4">
        <button
          ...
          className={`px-3.5 py-2.5 rounded-xl border text-xs font-semibold flex items-center gap-2 transition-all ${
            isListening
              ...
              : "bg-zinc-100 dark:bg-white/[0.03] border-zinc-200 dark:border-white/10 hover:border-amber-500/50 text-zinc-800 dark:text-zinc-200"
          }`}
        >
        ...
        <input
          ...
          className="flex-1 bg-zinc-100 dark:bg-white/[0.03] border border-zinc-200 dark:border-white/10 focus:border-emerald-500 rounded-xl px-4 py-2.5 text-xs text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500 outline-none transition-all"
        />
        ...
        <button
          ...
          className="px-5 py-2.5 bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-zinc-950 rounded-xl font-display text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-1.5 shrink-0 shadow-sm shadow-emerald-500/20"
        >
        ...
        <div className="flex flex-wrap gap-2">
          {samplePrompts.map((prompt, idx) => (
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-zinc-100 dark:bg-white/[0.02] hover:bg-zinc-200 dark:hover:bg-white/10 border border-zinc-200 dark:border-white/[0.06] text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white text-xs text-left transition-all"
            >
              &ldquo;{prompt}&rdquo;
            </button>
          ))}
